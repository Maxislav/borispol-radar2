		...
		data: function () {
		 ...
		 this.interval= setInterval(()=>{
			...
			return {
				...
				text: 'На основании письменного запроса Государственного предприятия «Украинский авиационный метеорологический центр»,\n' +
					'информация ДМРЛ Борисполь не отображается.',
				suffix: '',
